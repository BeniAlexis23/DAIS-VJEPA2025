    ...
    <footer className="pt-16 bg-darkmode">
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        <div className="grid grid-cols-1 sm:grid-cols-12 lg:gap-20 md:gap-6 sm:gap-12 gap-6  pb-16">
          ...
          <div className="lg:col-span-2 md:col-span-3 col-span-6">
            <h4 className="text-white mb-4 font-medium text-24">Áreas de Proyectos</h4>
            <ul>
          ...
          <div className="lg:col-span-4 md:col-span-6 col-span-12  text-left mt-6 lg:mt-0">
            <h3 className="text-white text-24 font-medium mb-4">Web - FI</h3>
            <a
              href="https://fi.undc.edu.pe/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block border border-dark_border border-opacity-60 text-white py-3 px-5 rounded-lg hover:bg-dark_border transition duration-300"
            >
              https://fi.undc.edu.pe/
            </a>
          </div>
        </div>
      </div>
