      ...
      <div className="lg:py-0 py-2">
        ...
        >
          <div className="flex items-center justify-between p-4">
            <h1 className="text-lg font-bold text-midnight_text dark:text-midnight_text flex items-center justify-between gap-4">
              <Logo />
              <p className="font-extrabold text-3xl">DAIS - FI</p>
            </h1>
